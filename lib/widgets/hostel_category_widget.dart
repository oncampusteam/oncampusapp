...
class HostelCategoryWidget extends StatefulWidget {
  final String username;
  const HostelCategoryWidget({super.key, required this.username});

  @override
  State<HostelCategoryWidget> createState() => _HostelCategoryWidgetState();
}

class _HostelCategoryWidgetState extends State<HostelCategoryWidget> {
  bool favorite = false;
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Get.to(
                            () => HostelDeails(username: widget.username),
                        ...
                        child: Container(
                            ...
                            padding: EdgeInsets.only(
                                left: ScreenDetails.percentage(percent: 2, quantityToScale: "Heihgt"), top: 5.h, bottom: 5.h),
                            decoration: BoxDecoration(
                            ...
                            child: Row(
                                ...
                                children: [
                                  SizedBox(
                                      ...
                                      height: 80.h,
                                      width: 80.w,
                                      child: Image.asset('assets/hostel_category_widget/media.png')),
                                  SizedBox(
                                    width: 10.h,
                                  ),
                                  Container(
                                  ...
                                  Expanded(
                                    child: Container(
                                      ...
                                      // color: Colors.blue,
                                      // width: 60.w,
                                      padding: EdgeInsets.only(top: 5.h, right: 10.h),
                                      child: Align(
